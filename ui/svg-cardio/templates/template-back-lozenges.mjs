...
>
  ...
  <defs>
    <pattern id="Pattern" x="-3.5" y="-3.5" width="7" height="7" patternUnits="userSpaceOnUse" patternTransform="scale({= ({innerWidth})/(7*[({innerWidth})/7]) }, {= ({innerHeight})/(7*[({innerHeight})/7]) })">
  ...
  <rect width="{innerWidth}" height="{innerHeight}" x="{=-{innerWidth}/2}" y="{=-{innerHeight}/2}" class="base" />
  <rect width="{innerWidth}" height="{innerHeight}" x="{=-{innerWidth}/2}" y="{=-{innerHeight}/2}" fill="url(#Pattern)" />
